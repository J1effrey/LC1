...
public class CloestPairOfPoints {
    ...
    public List<Point> initialData(String fileName) {
        ...
        try {
            br = new BufferedReader(new InputStreamReader(Objects.requireNonNull(CloestPairOfPoints.class.getResourceAsStream(fileName))));
    ...
    public static void main(String[] args) {
        CloestPairOfPoints cpop = new CloestPairOfPoints();
        // get points array
